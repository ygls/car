...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    cb.setEVERYPAGENUM(12);
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from sale order by id desc",13);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(7).toString() %></td>
       <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(11).toString() %></td>
        <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><font color=blue><strong><%=pagelist2.get(12).toString() %></strong></font></td>
        <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;">
        <font color=red><strong><%=Integer.parseInt( pagelist2.get(12).toString())-tb.getLast(pagelist2.get(0).toString()) %></strong></font></td>
