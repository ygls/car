...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from news order by id desc",5);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=delNEWS&id=<%=pagelist2.get(0).toString()%>" >删除</a> </td>
    </tr>
