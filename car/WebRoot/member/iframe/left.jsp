...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=basePath %>member/prep/index.jsp" target="MainFrame">购物车信息管理</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" > <a href="<%=basePath %>member/prep/wei.jsp" target="MainFrame">未发货订单管理</a></TD></TR>
  </TABLE>
   </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" ><a href="<%=basePath %>member/prep/yi.jsp" target="MainFrame">已发货订单管理</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
