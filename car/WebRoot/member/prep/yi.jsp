...
<%
	...
	if(member==null){
		...
		List pagelist3=tb.getPost(member,"已发货");
%>
<BODY>
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
	...
	<td align="center" style="border-bottom:1px dotted #ccc;"><%=i+1 %></td>
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;">
      <%if(pagelist2.get(5).equals("未申请")) {%>
      <a href="<%=basePath %>ComServlet?method=mTH&pid=<%=pagelist2.get(0).toString()%>">退货</a><%}else{out.println(pagelist2.get(5).toString());} %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;">
      <a href="<%=basePath %>HzpAction.do?method=mdelPost&pid=<%=pagelist2.get(0).toString()%>">删除</a></td>
    </tr>
